...
public class OrderService {
    ...
    private OrderDto convertToDTO(Orders orders){
        ...
        String username = (orders.getUser() != null && orders.getUser().getName() != null) ? orders.getUser().getName() : "Unknown";
        String email = (orders.getUser() != null && orders.getUser().getEmail() != null) ? orders.getUser().getEmail() : "Unknown";
